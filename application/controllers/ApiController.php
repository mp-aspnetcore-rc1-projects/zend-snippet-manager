    ...
    if ($this->getRequest()->isPost()):
      if ($loginForm->isValid($datas)):
        ...
        if ($auth == true):
          ...
          $this->view->success = false;
          $this->view->error = "Auth failed , user doesnt exists or account is not confirmed";
          //$loginForm->getElement("hash")->addError("Auth failed , user doesnt exists or account is not confirmed");
        endif;
      else:
        $this->view->success = false;
