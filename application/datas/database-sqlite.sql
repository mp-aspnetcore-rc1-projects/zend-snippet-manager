...
BEGIN TRANSACTION;
CREATE TABLE categories(id INTEGER PRIMARY KEY AUTOINCREMENT , title varchar(255) not null , description text);
INSERT INTO "categories" VALUES(1,'PHP','PHP langage');
INSERT INTO "categories" VALUES(2,'Javascript','javascript');
INSERT INTO "categories" VALUES(3,'Actionscript','actionscript');
INSERT INTO "categories" VALUES(4,'Html','html');
INSERT INTO "categories" VALUES(5,'Css','css');
INSERT INTO "categories" VALUES(6,'SQL','SQL langage');
INSERT INTO "categories" VALUES(7,'Perl','Perl langage');
INSERT INTO "categories" VALUES(8,'Ruby','Ruby langage');
INSERT INTO "categories" VALUES(9,'Python','Pythonlangage');
INSERT INTO "categories" VALUES(10,'Java','Java langage');
INSERT INTO "categories" VALUES(11,'Bash','Bash langage');
INSERT INTO "categories" VALUES(12,'CSharp','CSharp langage');
INSERT INTO "categories" VALUES(13,'VB','VBlangage');
INSERT INTO "categories" VALUES(14,'Coffeescript','Coffeescriptlangage');
INSERT INTO "categories" VALUES(15,'FSharp','FSharp langage');
INSERT INTO "categories" VALUES(16,'C/C++','C++ langage');
INSERT INTO "categories" VALUES(17,'Objective C','Objective C langage');
INSERT INTO "categories" VALUES(18,'BASIC','BASIC langage');
INSERT INTO "categories" VALUES(22,'MXML','MXML langage');
INSERT INTO "categories" VALUES(23,'Erlang','Erlang langage');
INSERT INTO "categories" VALUES(24,'ColdFusion','ColdFusion langage');
INSERT INTO "categories" VALUES(25,'Dart','Dart langage');
INSERT INTO "categories" VALUES(26,'Scala','Scala langage');
INSERT INTO "categories" VALUES(27,'Groovy','Groovy langage');
INSERT INTO "categories" VALUES(28,'XAML','XAML langage');
INSERT INTO "categories" VALUES(29,'LUA','LUA langage');
INSERT INTO "categories" VALUES(30,'Pascal','Pascal langage');
INSERT INTO "categories" VALUES(31,'Delphi','Delphi langage');
INSERT INTO "categories" VALUES(35,'Software','Software recipes');
INSERT INTO "categories" VALUES(36,'Apache','Everything related to the Apache Server.');
CREATE TABLE accounts (
      ...
      updated DATETIME NOT NULL, role varchar(255)  default null);
INSERT INTO "accounts" VALUES(1,'mparaiso','paraiso.marc@gmail.com','975ecb719692fa2bc7255b0c2dd2f3a4','',1,'',1333980477,1333980477,'user');
INSERT INTO "accounts" VALUES(2,'camus','aikah@free.fr','975ecb719692fa2bc7255b0c2dd2f3a4','',1,'',1334149054,1334149054,'user');
INSERT INTO "accounts" VALUES(3,'marc paraiso','mparaiso@online.fr','975ecb719692fa2bc7255b0c2dd2f3a4','75012',1,'',1333980477,1333980477,'administrator');
INSERT INTO "accounts" VALUES(4,'lealsofia','lealsofia@free.fr','975ecb719692fa2bc7255b0c2dd2f3a4','78012',1,'',1334257296,1334257296,'user');
INSERT INTO "accounts" VALUES(5,'dsnippetmanager','dsnippetmanager@gmail.com','975ecb719692fa2bc7255b0c2dd2f3a4','',0,'b97f9aa3b2e432c0b295a4e24e7c2e58',1335408458,1335408458,'user');
INSERT INTO "accounts" VALUES(6,'afrobytes','afrobytes@free.fr','975ecb719692fa2bc7255b0c2dd2f3a4','USA',1,'',1335499975,1336796422,'user');
INSERT INTO "accounts" VALUES(7,'marqparaiso','afrobytes@online.fr','975ecb719692fa2bc7255b0c2dd2f3a4','France',1,'',1336924347,1336924347,'user');
INSERT INTO "accounts" VALUES(8,'aikah2','aikah2@free.fr','975ecb719692fa2bc7255b0c2dd2f3a4','France',0,'6e0f83ae22e256b5077f691a1fc6cb78',1337012774,1337012774,'user');
...
INSERT INTO "bugs" VALUES(1,'marc paraiso','aikah@free.fr',1334664775,'','this is a bug modified','high','new');
INSERT INTO "bugs" VALUES(2,'mark prades','paraiso.marc@gmail.com',1334664775,'','another bug','low','new');
INSERT INTO "bugs" VALUES(4,'joseph mascis','Mparaiso@online.fr',1334664775,'','another bug report','med','resolved');
INSERT INTO "bugs" VALUES(5,'aikah','Mparaiso@online.fr',1334664775,'','this is a fresh new bug','high','in_progress');
INSERT INTO "bugs" VALUES(6,'max pain','lealsofia@free.fr',1334664775,'','another strange bug','med','in_progress');
INSERT INTO "bugs" VALUES(7,'marc paraiso','mparaiso@online.fr',1334664775,'','new bug','low','in_progress');
INSERT INTO "bugs" VALUES(8,'Frank Martin','afrobytes@online.fr',1334669545,'','this is the final bug','med','new');
INSERT INTO "bugs" VALUES(9,'Jack Vance','lealsofia@free.fr',0,'','this is another strange bug','high','in_progress');
INSERT INTO "bugs" VALUES(10,'Jean Bar','mparaiso@online.fr',1334669761,'','another bug','low','resolved');
INSERT INTO "bugs" VALUES(23,'Luc Aurélien','mparaiso@online.fr',1334669761,'','another bug','high','resolved');
INSERT INTO "bugs" VALUES(103,'Martin Dupond','mparaiso@online.fr',1334669761,'','another bug','med','new');
INSERT INTO "bugs" VALUES(120,'Stephane Carré','mparaiso@online.fr',1334669761,'','another bug','high','in_progress');
INSERT INTO "bugs" VALUES(121,'Arnaud Menard','a.menard@free.fr',1334670093,'','a cool bug','high','new');
INSERT INTO "bugs" VALUES(122,'Arnaud Jean','afrobytes@online.fr',1334670228,'','a strange bug','med','new');
INSERT INTO "bugs" VALUES(123,'marc paraiso','aikah@free.fr',1334670703,'','Les accents n''apparaissent pas correctement , à corriger.','low','new');
INSERT INTO "bugs" VALUES(124,'Eric échiquier','aikah@free.fr',1334693184,'','this is a good bug','med','new');
INSERT INTO "bugs" VALUES(125,'camus','lealsofia@free.fr',1334693420,'','a final bug','low','new');
CREATE TABLE menus(
id integer primary key,
name varchar(255) not null,
access_level varchar(255) not null, parent_id integer);
INSERT INTO "menus" VALUES(1,'menu1 updated','administrator',NULL);
INSERT INTO "menus" VALUES(2,'menu2','administrator',NULL);
INSERT INTO "menus" VALUES(3,'admin_menu','administrator',NULL);
CREATE TABLE menu_items(
      ...
      page_id integer,
      link varchar(255),
      position integer , action varchar(255));
INSERT INTO "menu_items" VALUES(1,1,'this is the first item','','http://google.com',3,NULL);
INSERT INTO "menu_items" VALUES(2,2,'second item','','http://twitter.com',2,NULL);
INSERT INTO "menu_items" VALUES(3,1,'another menu item','','http://facebook.com',2,NULL);
INSERT INTO "menu_items" VALUES(4,1,'yet another link','','http://stackoverflow.com',4,NULL);
INSERT INTO "menu_items" VALUES(5,1,'this is a new item','','http://microsoft.com',6,NULL);
INSERT INTO "menu_items" VALUES(6,3,'manage snippets','','',2,'/snippet');
INSERT INTO "menu_items" VALUES(7,3,'manage accounts','','',0,'/account');
INSERT INTO "menu_items" VALUES(8,3,'Manage categories','','',1,'/category');
INSERT INTO "menu_items" VALUES(9,3,'Manage menus','','',3,'/menu');
INSERT INTO "menu_items" VALUES(10,3,'Manage Bugs','','',6,'/bug');
INSERT INTO "menu_items" VALUES(11,3,'Manage tests','','',1,'/test');
CREATE TABLE access_levels_ALTER_BACKUP_1334879043(
  id integer,
  access_level INTEGER,
  label varchar(255)
);
INSERT INTO "access_levels_ALTER_BACKUP_1334879043" VALUES(1,'','guest');
INSERT INTO "access_levels_ALTER_BACKUP_1334879043" VALUES(2,'','user');
CREATE TABLE [access_levels] (
[id] integer  PRIMARY KEY NULL,
[access_level] INTEGER DEFAULT '0' UNIQUE NOT NULL,
[label] varchar(255)  NOT NULL
);
INSERT INTO "access_levels" VALUES(1,0,'guest');
INSERT INTO "access_levels" VALUES(2,1,'user');
INSERT INTO "access_levels" VALUES(3,2,'administrator');
CREATE TABLE tests(
id integer primary key,
...
INSERT INTO "tests" VALUES(2,'another test updated','this is another test',1335762325,1335118703);
INSERT INTO "tests" VALUES(4,'another test','another test',1336835641,1336835641);
INSERT INTO "tests" VALUES(5,'a cool test','a cool test',1336835664,1336835664);
INSERT INTO "tests" VALUES(6,'a neat test','a neat test',1336835690,1336835690);
INSERT INTO "tests" VALUES(7,'the best test','the best test',1336835708,1336835708);
INSERT INTO "tests" VALUES(8,'luc''s test','luc''s test',1336835749,1336835749);
INSERT INTO "tests" VALUES(9,'valery''s test','valery''s test',1336835772,1336835772);
INSERT INTO "tests" VALUES(10,'david test','david test',1336835795,1336835795);
INSERT INTO "tests" VALUES(11,'karl test','karl test',1336835816,1336835816);
INSERT INTO "tests" VALUES(12,'ludovic test','ludovic test',1336835839,1336835839);
INSERT INTO "tests" VALUES(13,'a final test to show','a final test to show',1336836408,1336836408);
INSERT INTO "tests" VALUES(14,'did i say final test ?','did i say final test ?',1336836431,1336836431);
INSERT INTO "tests" VALUES(15,'som other cool tests','som other cool tests',1336836881,1336836881);
INSERT INTO "tests" VALUES(16,'great great test','great great test',1336836900,1336836900);
CREATE TABLE menu_item_types(
id integer primary key,
name varchar(255)
);
INSERT INTO "menu_item_types" VALUES(1,'external link');
INSERT INTO "menu_item_types" VALUES(2,'internal link');
INSERT INTO "menu_item_types" VALUES(3,'resource/module/controller/action/params...');
CREATE TABLE favorites(id integer primary key, user_id integer not null, snippet_id integer not null );
INSERT INTO "favorites" VALUES(2,3,2);
INSERT INTO "favorites" VALUES(4,3,4);
INSERT INTO "favorites" VALUES(5,3,5);
INSERT INTO "favorites" VALUES(7,3,54);
INSERT INTO "favorites" VALUES(8,3,40);
INSERT INTO "favorites" VALUES(9,3,31);
INSERT INTO "favorites" VALUES(10,3,26);
INSERT INTO "favorites" VALUES(11,3,29);
INSERT INTO "favorites" VALUES(12,3,20);
INSERT INTO "favorites" VALUES(14,3,36);
INSERT INTO "favorites" VALUES(15,3,24);
INSERT INTO "favorites" VALUES(16,3,8);
INSERT INTO "favorites" VALUES(17,3,55);
INSERT INTO "favorites" VALUES(18,3,34);
INSERT INTO "favorites" VALUES(19,3,52);
INSERT INTO "favorites" VALUES(20,3,53);
INSERT INTO "favorites" VALUES(21,3,58);
INSERT INTO "favorites" VALUES(22,7,59);
INSERT INTO "favorites" VALUES(23,2,61);
INSERT INTO "favorites" VALUES(24,2,63);
INSERT INTO "favorites" VALUES(25,2,66);
INSERT INTO "favorites" VALUES(26,3,67);
INSERT INTO "favorites" VALUES(27,2,68);
DELETE FROM sqlite_sequence;
INSERT INTO "sqlite_sequence" VALUES('categories',36);
CREATE VIEW snippets_categories as select * from snippets join categories on snippets.category_id = categories.id;
COMMIT;
